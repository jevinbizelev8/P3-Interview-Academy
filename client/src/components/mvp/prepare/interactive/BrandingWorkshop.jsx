...
export default function BrandingWorkshop() {
  ...
  const identityExamples = [
    ...
    {
      format: "I am a [role] who [unique value] for [target] through [how]",
      example: "I am a software engineer who builds scalable backend systems for high-traffic applications through clean architecture and performance optimisation." // Changed 'optimization' to 'optimisation' for Singapore English
    },
    {
      format: "I am a [role] who [unique value] for [target] through [how]",
  ...
  const brandingElements = [
    {
      ...
      description: "Who are you in the professional world?",
      prompt: "In one sentence, describe your professional identity. Think: role + experience + unique strength",
      example: "I'm a growth-focused marketing leader with 8 years of experience turning data insights into scalable acquisition strategies.",
      tips: [
        "Lead with your role or speciality", // Changed 'specialty' to 'speciality' for Singapore English
        "Include your years of experience",
        "Add one unique differentiator",
    ...
    },
    {
      ...
      description: "What's the ONE thing you do exceptionally well?",
      prompt: "What's your professional superpower? What do colleagues always come to you for?",
      example: "I have an uncanny ability to simplify complex technical concepts and get cross-functional teams aligned on a shared vision.",
      tips: [
        "Think about what you're known for",
        "What have you been consistently praised for?",
    ...
    {
      id: 3,
      title: "🏆 Your Proof Point",
      description: "One achievement that proves your superpower",
      prompt: "Share ONE concrete achievement that demonstrates your superpower (with metrics if possible)",
      example: "I led a product redesign that increased user engagement by 45% and reduced support tickets by 30% within 3 months.",
      tips: [
        "Use specific numbers and timeframes",
        "Focus on business impact, not just tasks",
        "Choose something recent (last 2-3 years)",
        "Make it relevant to your target role"
      ]
    },
    {
      id: 4,
      title: "❤️ Your 'Why'",
      description: "What motivates you professionally?",
      prompt: "Why do you do what you do? What gets you excited about your work?",
      example: "I'm driven by the challenge of scaling products from thousands to millions of users. There's nothing more thrilling than solving problems at that scale.",
      tips: [
        "Be genuine - this should excite you",
        "Connect it to the type of work you want",
        "Show passion without being overly emotional",
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
                  ...
                  <p className="text-sm text-blue-800 italic leading-relaxed">
                    "I discovered my passion for data analysis during my first internship at a retail company, where I noticed patterns in customer behaviour that no one had explored. That curiosity led me to pursue analytics formally. Over the past 5 years, I've specialised in e-commerce analytics, helping companies understand and predict customer behaviour. Now I'm looking to take that expertise to a product-focused role where I can directly influence what we build based on data insights." {/* Changed 'behavior' to 'behaviour' and 'specialized' to 'specialised' */}
                  </p>
                </div>
