...
import { CheckCircle2, XCircle, ArrowRight, Users, Trophy, Lightbulb } from "lucide-react";
...
export default function TeamDynamicsGame() {
  ...
  const communicationStyles = [
    { id: 1, style: "Analytical", description: "Data-driven, wants proof and metrics" },
    { id: 2, style: "Driver", description: "Results-focused, impatient with details" },
    { id: 3, style: "Expressive", description: "Big-picture, enthusiastic storyteller" },
    { id: 4, style: "Amiable", description: "Relationship-focused, collaborative" }
  ];

  const matchingExercise = [
    { approach: "Start with data and ROI", style: "Driver" },
    { approach: "Build rapport before business", style: "Amiable" },
    { approach: "Use stories and enthusiasm", style: "Expressive" },
    { approach: "Provide detailed analysis", style: "Analytical" }
  ];
      ...
      <Card className="border-2 border-purple-200 bg-gradient-to-r from-purple-50 to-pink-50">
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-semibold">Team Dynamics Module: Step {currentStep} of 5</span>
